...
5. **Respect du socle de fondations** : les essais de fondation `.dev/fondations/FND-0XY-*.md` sont le **socle théorique et méthodologique normatif** du projet. Avant d'exécuter une tâche (contenu, design, communication, recherche), identifier le ou les FND qui couvrent le sujet, lire avant d'agir, aligner le livrable dessus et le citer dans l'artefact. Ne jamais contredire un FND sans l'acter explicitement (nouvel artefact ou ADR). Les faits des FND sont sourcés et datés : signaler toute donnée potentiellement périmée (plusieurs FND portent la mention « vérifié à juin 2026, à revalider »). Repères de portée : FND-001/007/008/009/011 (Linux, usages, PQC par image), FND-006 (CBOM), FND-010 (risque quantique), FND-012/013/014 (communication, LinkedIn, Davos 2026), FND-002/003/004/005 (design des tokens, fondements mathématiques), FND-015 (design des diapositives).
