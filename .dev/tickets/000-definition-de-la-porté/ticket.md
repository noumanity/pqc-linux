...
> (référence), [`premier-jet.md`](premier-jet.md) (matériel de promotion),
> [`/.dev/fondations/recherche-preliminaire-pqc-distributions-linux.md`](../../fondations/recherche-preliminaire-pqc-distributions-linux.md).
