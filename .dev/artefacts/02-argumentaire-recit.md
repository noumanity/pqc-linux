...
On passe du « tell » au « show ». La communauté internationale a agi : standards PQC du NIST (ML-KEM, ML-DSA, SLH-DSA), équivalents européens (BSI, ANSSI, ETSI), déclaration du G7. Les autorités canadiennes ont agi : le Centre canadien pour la cybersécurité a publié une feuille de route de migration (ITSM.40.001) assortie d'obligations contraignantes pour les systèmes du gouvernement, et un guide aux organisations (ITSAP.00.017). Déclinaison du leitmotiv portée à la salle : qu'arriverait-il si on était les seuls à ne pas agir ? Puis : voici comment les autres s'y prennent, c'est cadré. Et vous ? Pour rendre la responsabilité immédiatement actionnable, on met un premier outil entre les mains de l'auditoire : l'inégalité de Mosca. Elle compare la durée de vie de confidentialité des données plus le temps de migration au temps restant avant le Q-Day ; si la somme dépasse ce délai, on est déjà en retard. Chacun peut l'appliquer à sa propre infrastructure, séance tenante : c'est le « voici comment, et c'est à votre portée » du leitmotiv, et cet outil fait monter en compétence les deux audiences (cf. FND-010). Message décideurs : cet enjeu est-il couvert par vos processus de cybersécurité, vos veilles stratégiques ?
